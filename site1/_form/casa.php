...
<div id="form-option">
    ...
    <form method="post" action="" oninput="calc_total();">
        ...
        <fieldset id="fieldset-maior"> <legend> Dados do Produto </legend>
            <table>
                <tr> <td> <label for="iEndereco"> Endereço: </label>
                        <input type="text" name="nEndereco" id="iEndereco" placeholder="Endereço" maxlength="40" size="40"/> </td>
                    <td> <label for="iNumero"> Número: </label>
                        <input type="number" name="nNumero" id="iNumero" placeholder="" min="0" max="5"/> </td>
                    <td> <label for="iComplemento"> Complemento: </label>
                        <input type="text" name="nComplemento" id="iComplemento" placeholder="" maxlength="40"/> </td>
                </tr>
            </table>
            <br/>
            <table>
        ...
        <fieldset id="fieldset-menor1"> <legend> Medidas da Casa </legend>
            <table>
                <tr>
        ...
        <fieldset id="fieldset-menor2"> <legend> Características do seu imóvel </legend>
            <table>
                <tr>
                    <td> <label for="iQuartos"> Quartos: </label>
                        <input type="number" name="nQuartos" id="iQuartos" placeholder="0" min="0" max="3"/> </td>
                    <td> <label for="iSuites"> Suítes: </label>
                        <input type="number" name="nSuites" id="iSuites" placeholder="0" min="0" max="3"/> </td>
                </tr>
                <tr>
                    <td> <label for="iGaragem"> Vagas de Garagem: </label>
                        <input type="number" name="nGaragem" id="iGaragem" placeholder="0" min="0" max="3"/> </td>
                </tr>
            </table>
        </fieldset>

        <fieldset id="fieldset-maior"> <legend> Quanto custa seu Imóvel? </legend>
