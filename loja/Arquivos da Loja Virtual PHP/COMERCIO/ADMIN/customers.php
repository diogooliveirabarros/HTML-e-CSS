...
*/
  ...
  if ($HTTP_GET_VARS['action']) {
    switch ($HTTP_GET_VARS['action']) {
	  ...
	  $documento_cliente = tep_db_prepare_input($HTTP_POST_VARS['documento_cliente']);
...
<?php
  if ($HTTP_GET_VARS['action'] == 'edit') {
    $customers_query = tep_db_query("select c.customers_gender, c.customers_firstname, c.customers_lastname, c.customers_dob, c.customers_email_address, c.documento_cliente, a.entry_company, a.entry_street_address, a.entry_suburb, a.entry_postcode, a.entry_city, a.entry_state, a.entry_zone_id, a.entry_country_id, c.customers_telephone, c.customers_fax, c.customers_newsletter, c.customers_default_address_id from " . TABLE_CUSTOMERS . " c left join " . TABLE_ADDRESS_BOOK . " a on c.customers_default_address_id = a.address_book_id where a.customers_id = c.customers_id and c.customers_id = '" . $HTTP_GET_VARS['cID'] . "'");
...
<? //DW ---> ?>
	    ...
	    <tr>
            ...
            <td class="main"><?php echo tep_draw_input_field('documento_cliente', $cInfo->documento_cliente, '', true); ?></td>
          </tr>
...
<?php
    ...
    $customers_query_raw = "select c.customers_id, c.customers_lastname, c.customers_firstname, c.customers_email_address, c.documento_cliente, a.entry_country_id from " . TABLE_CUSTOMERS . " c left join " . TABLE_ADDRESS_BOOK . " a on c.customers_default_address_id = a.address_book_id where c.customers_id = a.customers_id and (c.customers_lastname like '" . $search . "' or c.customers_firstname like '" . $search . "') order by c.customers_firstname";
