...
<!-- body_text //-->
  <td width="100%" valign="top">
    <table border="0" width="600" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="2" class="pageHeading">Indexar a Database<br><br></td>
      </tr>
<?php if($create_indexes){ ?>
      <tr>
        <td colspan="2" class="smallText"><b>Indexar o banco de dados da loja à deixará mais leve e rápida.</b><a href="<?php echo $PHP_SELF; ?>?create_indexes=again"> Click aqui</a>!<br><br></td>
      </tr>
      <tr>
        <td class="smallText"><b>Databases de vermelho não indexaram...</b><br></td>
        <td class="smallText"><b>... E as verdes foram indexadas!</b><br></td>
      </tr>
      <tr>
        <td class="smallText">
        <?php
